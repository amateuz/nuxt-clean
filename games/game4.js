const createGame = (config = {}) => {
  ...
  var robot;
  var words = [];
  var startPos = [{ 'x': 212, 'y': 228 }, { 'x': 304, 'y': 273 }, { 'x': 363, 'y': 210 }, { 'x': 380, 'y': 274 }, { 'x': 256, 'y': 353 },
  { 'x': 226, 'y': 293 }, { 'x': 346, 'y': 345 }, { 'x': 282, 'y': 217 }];
  var endPos = [{ 'x': 200, 'y': 456 }, { 'x': 258, 'y': 457 }, { 'x': 319, 'y': 456 }, { 'x': 385, 'y': 456 }, { 'x': 201, 'y': 514 },
  { 'x': 267, 'y': 513 }, { 'x': 340, 'y': 513 }, { 'x': 385, 'y': 512 }];
  var minDistanceToStick = 15;
  var checks = [0, 0, 0, 0, 0, 0, 0, 0, 0];
  var levels = {
    'level1': {
      'start': [{ 'x': 190, 'y': 601 }, { 'x': 359, 'y': 593 }, { 'x': 336, 'y': 673 }, { 'x': 266, 'y': 671 }, { 'x': 311, 'y': 629 }, { 'x': 291, 'y': 588 }, { 'x': 201, 'y': 669 }, { 'x': 240, 'y': 623 }],
      'end': [{ 'x': 206, 'y': 372 }, { 'x': 247, 'y': 372 }, { 'x': 294, 'y': 372 }, { 'x': 346, 'y': 374 }, { 'x': 196, 'y': 423 }, { 'x': 247, 'y': 423 }, { 'x': 298, 'y': 425 }, { 'x': 349, 'y': 424 }]
    },
    'level2': {
      'start': [{ 'x': 274, 'y': 653 }, { 'x': 219, 'y': 663 }, { 'x': 330, 'y': 604 }, { 'x': 264, 'y': 596 }, { 'x': 335, 'y': 657 }, { 'x': 200, 'y': 612 }],
      'end': [{ 'x': 228, 'y': 373 }, { 'x': 273, 'y': 373 }, { 'x': 318, 'y': 375 }, { 'x': 222, 'y': 423 }, { 'x': 268, 'y': 424 }, { 'x': 322, 'y': 426 }]
    },
    'level3': {
      'start': [{ 'x': 235, 'y': 654 }, { 'x': 296, 'y': 657 }, { 'x': 197, 'y': 608 }, { 'x': 352, 'y': 648 }, { 'x': 301, 'y': 609 }, { 'x': 252, 'y': 599 }, { 'x': 183, 'y': 654 }, { 'x': 350, 'y': 600 }],
      'end': [{ 'x': 202, 'y': 376 }, { 'x': 251, 'y': 373 }, { 'x': 302, 'y': 375 }, { 'x': 356, 'y': 374 }, { 'x': 200, 'y': 426 }, { 'x': 246, 'y': 428 }, { 'x': 298, 'y': 425 }, {
        'x': 346, 'y': 425
      }]
    },
    //'level2': { 'start': [], 'end' : [] },
  ...
  var commonMusics = ['button_common', 'win_common', 'pic_set', 'pic_take', 'robovoice_1', 'robovoice_2', 'robovoice_3'];
  var musics = {};
  ...
  function preload() {
    ...
    for (let j = 1; j <= 3; j++) {
      ...
      for (let i = 1; i <= levels[level].start.length; i++) {
        that.load.image(level + '_word' + i.toString(), 'game4/' + level + '/word' + i.toString() + '.png');
      }
    }
  ...
  function startGame() {
    robot = that.add.image(284, 381, 'robot'); robot.setScale(0.5);
    ...
    that.input.on('dragend', function (pointer, gameObject) {
      ...
      if ((Math.pow(Math.abs(gameObject.x - endPos[i].x), 2) + Math.pow(Math.abs(gameObject.y - endPos[i].y), 2)) < Math.pow(minDistanceToStick, 2)) {
