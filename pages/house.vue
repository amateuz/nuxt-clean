<template>
  ...
  -->{{
                (
                  ...
                  ' ' +
                  getMagicWord(3) +
                  '\n\nОтправь полученное заклинание\nаудиосообщением в телеграм-канал, чтобы прогнать Крампуса\nи заработать памятные призы. Ссылка на канал появится в конце следующей страницы'
                ).trim()
              }}
            </div>
            <Btn
  ...
  -->{{
                (
                  ...
                  getMagicWord(3) +
                  '\n\n' +
                  'Отправь полученное заклинание\nаудиосообщением в телеграм-канал, чтобы прогнать Крампуса\nи заработать памятные призы.\nСсылка на канал появится в конце следующей страницы.'
                ).trim()
              }}
            </template>
          </div>
