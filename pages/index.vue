        ...
        <div class="house">
            <div class="container">
                <template v-for="floorNum in floorCount">
                    <div class="floor floor-link floor-img">
                        <img
                            class="floor__img"
...
export default {
    ...
    methods: {
        animateHero(fromHero, toHero) {
            ...
            let from = this.calculatePosition(fromHero)
            let to = this.calculatePosition(toHero)
        ...
        calculatePosition(element) {
            ...
            let scrollTop = window.pageYOffset || this.$root.scrollTop || 0
            let scrollLeft = window.pageXOffset || this.$root.scrollLeft || 0

            let clientTop = this.$root.clientTop || 0
            let clientLeft = this.$root.clientLeft || 0
